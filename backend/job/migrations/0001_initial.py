    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(help_text='ChatGPT에 보낸 프롬프트 텍스트', verbose_name='Prompt Text')),
                ('hash', models.CharField(help_text='프롬프트 텍스트의 고유 해시값', max_length=64, unique=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('file', models.FileField(blank=True, null=True, upload_to=job.models.user_upload_path, validators=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_data', models.FileField(blank=True, null=True, upload_to=job.models.user_taskunit_path,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prompt', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='responses',
                                             to='job.prompt', verbose_name='Prompt')),
        ...
        migrations.AddIndex(
            model_name='taskunitresponse',
            index=models.Index(fields=['prompt'], name='task_unit_r_prompt__2eef7a_idx'),
        ),
    ]

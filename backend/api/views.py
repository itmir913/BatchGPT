...
class CreateBatchJobsView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            cache.delete(reverse('list-batch-jobs'))
...
class BatchJobDetailView(APIView):
    ...
    def patch(self, request, batch_id):
        ...
        if serializer.is_valid():
            serializer.save()
            cache.delete(reverse('batch-job-detail', args=[batch_id]))
            cache.delete(reverse('batch-job-configs', args=[batch_id]))
    ...
    def delete(self, request, batch_id):
        ...
        cache.delete(reverse('batch-job-detail', args=[batch_id]))
        cache.delete(reverse('batch-job-configs', args=[batch_id]))
        cache.delete(reverse('batch-job-preview', args=[batch_id]))
